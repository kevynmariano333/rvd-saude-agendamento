 ...
 */
function ActionIcon({ label, icon: Icon, onClick, confirmed = false, somenteLeitura = false }: { label: string; icon: typeof FileText; onClick: () => void; confirmed?: boolean; somenteLeitura?: boolean }) {
  ...
  return <button onClick={onClick} title={label} className={`rounded-lg p-1.5 hover:bg-rvd-plum-pale ${confirmed ? `${cor} hover:bg-emerald-100` : ""}`}><Icon className="size-4" /></button>;
}
/**

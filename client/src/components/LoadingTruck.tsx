    ...
    <div className="flex min-h-screen items-center justify-center overflow-hidden bg-white px-6">
      <div className="relative w-full max-w-md text-center">
        ...
        <div className="relative mx-auto flex h-36 w-52 items-center justify-center motion-safe:animate-[pulse_1.6s_cubic-bezier(0.23,1,0.32,1)_infinite]">
          <div className="relative rounded-2xl bg-rvd-plum p-4 shadow-[0_16px_32px_rgba(120,32,120,0.18)]">
            <Truck className="size-16 text-rvd-blue" strokeWidth={1.7} />
            <img src="/manus-storage/RVD-Saude_f78a565b.png" alt="RVD Saúde" className="absolute left-6 top-8 size-7 rounded-md bg-white object-cover p-0.5" />
        ...
        <p className="mt-5 font-display text-lg font-extrabold text-rvd-plum">{label}</p>
        <p className="mt-2 text-sm text-rvd-plum">RVD Saúde Agendamento</p>
      </div>
    </div>
  );
}
